...
$lang_translation=array( // If you comment a language here, it won't be displayed. 
			"fr_FR" => "Français",
			"en_US" => "English",
//			"es_ES" => "Español",
//			"it_IT" => "Italiano",
...
$langpath = bindtextdomain("messages", dirname(__FILE__)."/locales");
...
if (!(isset($lang))) {  // Use the browser first preferred language
  list($lang)=explode(",",trim($_SERVER["HTTP_ACCEPT_LANGUAGE"]));
